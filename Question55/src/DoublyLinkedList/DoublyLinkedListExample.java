...
public class DoublyLinkedListExample {
	...
	public DoublyLinkedListExample(Node head) {
		this.head = head;
	}
	...
	// Detect a loop in linked list. If linked list has loop, find the start node
	// for the loop.
	...
	public int findIntersection(DoublyLinkedListExample list) {
		Node tempThis = head;
		while (tempThis != null) {
			Node tempList = list.getHead();
			while (tempList != null) {
				if (tempThis.data == tempList.data) {
	...
	public Node reverseLinkedListInPairs() {
		Node curr = head;
		Node temp = null;
		Node newHead = null;
