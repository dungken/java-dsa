...
public class BinaryTreeExample {
	...
	public static void main(String[] args) {
		...
		System.out.println(bi.LCA(rootNode, new TreeNode(5), new TreeNode(30)).data);
		System.out.println(bi.LCA(rootNode, new TreeNode(5), new TreeNode(55)).data);
		System.out.println(bi.LCA(rootNode, new TreeNode(60), new TreeNode(70)).data);
	}
