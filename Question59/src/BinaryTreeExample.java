...
public class BinaryTreeExample {
	...
	public static void main(String[] args) {
		...
		//
		System.out.println("Print left nodes using recurtion");
		bi.printLeafNodesUsingRecursive(rootNode);
		
		System.out.println("Print left nodes using iteration");
		bi.printLeafNodesUsingIterative(rootNode);
